...
- Utwórz projekt React z create-vite: `npm init --yes vite@latest rozproszony_system_aukcyjny_rest_api.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Utwórz plik projektu (`rozproszony_system_aukcyjny_rest_api.client.esproj`).
